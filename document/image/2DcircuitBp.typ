...
#cetz.canvas(length: 1pt, {
  ...
  hadamard("site21")
  cnot("site21", "site11",offset: 1.5*gate-offset)
  cnot("site21","site22",offset: 2*gate-offset)
  cnot("site22","site12",offset: 2.5*gate-offset)

  hadamard("site13",offset: 2.5*gate-offset)
  cnot("site13","site12",offset: 3.5*gate-offset)

  hadamard("site31",offset: 3*gate-offset)
  cnot("site31","site32",offset: 3.5*gate-offset)

  hadamard("site33",offset: 3*gate-offset)
  cnot("site33","site32",offset: 4.5*gate-offset)
  cnot("site33","site23",offset: 5*gate-offset)
  cnot("site23","site22",offset: 5.8*gate-offset)

port("site21", 177, 20, fill-color: red)
port("site13", 146, 196, fill-color: red)
