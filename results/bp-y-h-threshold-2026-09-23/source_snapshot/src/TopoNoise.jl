...
export ToricCodePEPS, physicalinds, toric_code_local_tensor, toric_code_peps,
       ...
       VerifiedAsEncoder, verified_as_encoder, VerifiedAsNoise, VerifiedAsFaultRecord,
       with_measurement_fault, propagate_verified_as, sample_verified_as_yao,
       audit_verified_as_single_faults, estimate_verified_as_failure,
...
include("rotated_planar/verified_as.jl")
include("rotated_planar/verified_as_analysis.jl")
